/*
 * 1.Calcular o consumo de um carro (Consumo?)
 * 2.Calcular a distancia máxima que um carro ou moto pode percorrer ao realizar o abastecimento de um veículo (Autonomia?)
 */
